...
// Please note: TransformStack changed from a class to a stack of matrices,
// as this was found to be a simpler and overall better implementation
typedef stack <Matrix*> TransformStack;
